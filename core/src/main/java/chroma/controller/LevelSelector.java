...
public class LevelSelector {
    ...
    public LevelSelector(AssetDirectory directory) {
        ...
        levelFiles = new String[] {
            "level_1","level_3_spray","level_2","level_3_bomb","level_3","alex_level6","alex_level", "alex_level8", "level_grate","level_5", "level_4", "level_12", "level_13", "level_14", "level_8", "level_6", "cooper_level"
        };
        currentLevelIndex = 0;
    }
